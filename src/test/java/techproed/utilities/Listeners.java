...
public class Listeners implements ITestListener,IRetryAnalyzer, IAnnotationTransformer {
    ...
    public void transform(ITestAnnotation annotation, Class testClass, Constructor testConstructor, Method testMethod) {
        /*
            Bu methodun amacı; test notasyonlarını, sınıfları,
             cons.ları ve methodları transform(dönüştürme) etmemize
            olanak sağlar
            Bu method sayesinde @Test annotation a sahip methodları
             yapılandırıp testin başarısız olma durumunda
            otomatik olarak testleri retry methodunda belirttiğimiz
             sayı miktarınca tekrar çalıştıracaktır.
         */
