...
public class C06_SoftAssert {
    /*
        SoftAssert kullanımında junitteki daha önce kullandığımız methodların aynısını
    kullanırız.Daha önceden kullandığımız assertion nerde hata alırsa orda testlerin
    çalışmasını durdurur.SoftAssert'te ne kadar assertion kullansakta nerde
    assertAll() methodu kullanırsak testlerimiz de kullandığımız assertionlar orda
    sonlanır ve hata varsa konsolda belirtir.
     */
    WebDriver driver;
    @BeforeMethod
    public void setUp() {
